...
public class ViewFRahmen {
	...
	private void openScene(String datei, String name) {
		try {
	...
	public void initialize() {
		openScene("FDashboard.fxml", "Dashboard");
	}
