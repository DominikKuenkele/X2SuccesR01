...
CREATE TABLE `graduation` (
  ...
  PRIMARY KEY (`GID`),
  UNIQUE KEY `abschluss_UNIQUE` (`graduation`),
  UNIQUE KEY `hierarchie_UNIQUE` (`hierarchy`)
...
INSERT INTO `graduation` VALUES (4,'Ausbildung',1),(5,'Bachelor',2),(6,'Master',3),(7,'Doktor',4);
